...
csv_files = [file for file in os.listdir(output_directory) if file.startswith('output_dqn_4000')]
...
colors = plt.cm.Greens(np.linspace(0.2, 0.8, num_colors))
...
plt.savefig('plots/combined_plot_4000.png')

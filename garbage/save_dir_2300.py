...
csv_files = [file for file in os.listdir(output_directory) if file.startswith('output_dqn_2300')]
...
colors = plt.cm.Blues(np.linspace(0.2, 0.8, num_colors))
...
plt.savefig('plots/combined_plot_2300.png')
